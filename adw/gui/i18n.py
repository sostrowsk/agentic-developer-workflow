...
_EN: dict[str, str] = {
    ...
    "nav_more": "more",
    "nav_of": "of",
    # Trace-tree compaction chrome (A7): repeat counter (A2), group count +
    # operation kinds (A3) and the per-page line balance (A6). Singular/plural forms
    ...
    "fold_row": "row",
    "fold_rows": "rows",
    "fold_event_folded_one": "event folded",
    "fold_event_folded_many": "events folded",
...
_DE: dict[str, str] = {
    ...
    "fold_row": "Zeile",
    "fold_rows": "Zeilen",
    "fold_event_folded_one": "Event eingefaltet",
    "fold_event_folded_many": "Events eingefaltet",
